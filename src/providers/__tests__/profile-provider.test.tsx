...
function TestHarness() {
  ...
  return (
    <div>
      ...
      <button data-testid="switch-p2" onClick={() => setActiveProfile(profileP2._id)} type="button">
        switch p2
      </button>
      <button data-testid="switch-p3" onClick={() => setActiveProfile(profileP3._id)} type="button">
        switch p3
      </button>
    </div>
  );
